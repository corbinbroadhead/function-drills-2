...
// CODE HERE
each(names, result = (item, ind) => console.log(`The item at index ${ind} is ${item}.`));
...
// CODE HERE
let addEightyEight = addingFactory(88);
console.log(addEightyEight(11));
